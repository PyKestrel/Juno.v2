...
// Gets current directory and add commands to it (ex: \juno.v2\commands)
const foldersPath = path.join(__dirname, 'commands');
// Reads sub-folders names under the commmands folder (ex: misc,music...)
...
// ========================= MODIFY SELECTION BELOW, BEGIN WITH createChannelConnection OR client.on ====================================================
